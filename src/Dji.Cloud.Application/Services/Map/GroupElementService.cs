...
public class GroupElementService : IGroupElementService
{
    //@Autowired
    ...
    //}
    public Task<bool> DeleteElementAsync(string elementId)
    {
    ...
    public Task<IEnumerable<GroupElement>> GetElementsByGroupIdAsync(string groupId)
    {
        throw new NotImplementedException();
    }

    public Task<bool> SaveElementAsync(string groupId, ElementCreate elementCreate)
    {
        throw new NotImplementedException();
    }

    public Task<bool> UpdateElementAsync(string elementId, ElementUpdate elementUpdate, string userName)
    {
        throw new NotImplementedException();
    }
}
